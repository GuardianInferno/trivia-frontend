            ...
            <div className="h-7/100 px-1  font-bold text-xl" style={{backgroundColor:'#ffb689', color:'#ffe0a7'}}>
                <nav className="h-full flex items-center">
                    ...
                    <div className="h-full w-full flex justify-evenly  items-center">
                        <Link to='/create' className="h-full px-2 hover:bg-orange-400 transition duration-500 ease flex justify-center items-center">Create</Link>
                        <Link to='/explore' className="h-full px-2 hover:bg-orange-400 transition duration-500 ease flex justify-center items-center">Explore</Link>
                    </div>
